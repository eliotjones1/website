    ...
    <section id="about" className="section-container">
      <div className="about-content">
        <div className="about-text">
          ...
          <p>I graduated from Stanford University in 2023 with my B.S. in Data Science, and in 2024 I graduated with my MsC in computer science, advised by Dr. Fei Fei Li.</p>
        </div>
